...
export default function MobileBottomBar() {
  ...
  return (
    <div className="md:hidden fixed bottom-0 left-0 right-0 z-40 bg-white border-t border-brand-border p-3 flex gap-3 shadow-[0_-4px_20px_rgba(27,123,138,0.08)]" data-testid="mobile-bottom-bar">
      ...
      <a href={buildWhatsAppLink(info.whatsapp_number)} target="_blank" rel="noreferrer" className="flex-1 inline-flex items-center justify-center gap-2 bg-[#25D366] text-white rounded-full px-6 py-3 font-display font-bold shadow-soft" data-testid="mobile-bar-whatsapp">
