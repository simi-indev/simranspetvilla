    ...
    >
      <div className="flex items-start justify-between gap-3 mb-4">
        ...
        <div className="text-right">
          ...
          <div className="font-display font-extrabold text-brand-secondary text-lg">₹{service.starting_price}<span className="text-sm font-normal text-brand-muted">/{service.unit}</span></div>
        </div>
      </div>
      <h3 className="font-display font-extrabold text-xl text-brand-ink mb-1.5">{service.name}</h3>
      <p className="text-sm text-brand-muted leading-relaxed mb-4 min-h-[42px]">{service.tagline}</p>
